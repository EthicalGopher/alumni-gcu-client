            ...
            <div className="art-container">
                <div className="vc-message-container">
                    <div class="letter">
                        ...
                        <p>At GCU, we embrace the philosophy that education extends beyond academic boundaries. We believe in nurturing intellectual curiosity, fostering innovation, and encouraging a global perspective among our students. As we march forward, the role of our alumni becomes paramount in shaping the university's legacy. The Girijananda Chowdhury Alumni Association (GCAA) is a vital initiative to strengthen the bond between the institution and its graduates, building a vibrant community that thrives on shared experiences and aspirations.</p>
                        <p>The alumni of GIMT and GIPS, now integral to GCU’s identity, are our greatest ambassadors. Their remarkable achievements across the globe exemplify the transformative power of education and inspire our current students. We warmly invite our alumni to join this collaborative effort by sharing their journeys, expertise, and insights to guide and mentor the next generation of learners. Together, we can become a beacon of hope and opportunity, empowering the youth to achieve their dreams and contribute meaningfully to society.</p>
                        <p>As we look to the future, I am confident that GCU will continue to uphold its legacy of academic excellence, innovation, and community engagement. Let us work together to build a university that not only imparts knowledge but also inspires change and fosters leadership.</p>
                        <p><strong>Professor Kandarpa Das <br />
                            Vice-Chancellor <br />
